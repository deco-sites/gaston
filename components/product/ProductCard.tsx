...
function ProductCard({
  ...
  return (
    <div
      id={id}
      class={`card card-compact group w-full text-primary-content ${
      ...
      >
        ...
        >
          <Image
            ...
            width={WIDTH}
            height={HEIGHT}
            class={`bg-base-100 rounded-2xl border border-black border-opacity-10 col-span-full row-span-full w-full ${
